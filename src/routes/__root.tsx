...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "OXIDAȚII — Orașul e live" },
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/02ee1384-0276-47c6-b7ec-59c03df63489/id-preview-0be21fcc--c7d68625-ce68-4035-8023-bc8b4887c4dd.lovable.app-1780424359857.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/02ee1384-0276-47c6-b7ec-59c03df63489/id-preview-0be21fcc--c7d68625-ce68-4035-8023-bc8b4887c4dd.lovable.app-1780424359857.png" },
