...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Termenii și condițiile de utilizare a aplicației OXIDAȚII." },
...
function TermsPage() {
  return (
    <LegalPage title="Termeni și condiții" updated="29 mai 2026">
      <p>
        Bine ai venit pe OXIDAȚII. Folosind aplicația, ești de acord cu acești
      ...
      <p>
        Tu rămâi proprietarul conținutului (foto, video, text) pe care îl
        postezi. Ne acorzi o licență neexclusivă, gratuită și mondială pentru
        a-l afișa, redistribui și modera în cadrul aplicației, strict pentru
      ...
      <p>
        Putem suspenda sau șterge orice cont care încalcă aceste reguli, fără
        notificare prealabilă și fără rambursare.
      </p>

      <h2>4. Consumul responsabil de alcool</h2>
      <p>
        OXIDAȚII este o aplicație despre cultura nightlife-ului. Promovăm
        consumul responsabil. Nu conduce dacă ai băut. Cunoaște-ți limitele.
        Dacă crezi că tu sau cineva apropiat are o problemă cu alcoolul,
        contactează Alcoolicii Anonimi România (<a href="https://www.aa-romania.ro">aa-romania.ro</a>).
      </p>

      <h2>5. Verificare AI și moderare</h2>
      <p>
        Anumite postări (ex. „proof de șpriț") sunt verificate automat de un
        sistem AI. Verificarea este o estimare, nu o garanție. Putem reverifica
        sau șterge manual orice postare suspectă.
      </p>

      <h2>6. Disponibilitatea serviciului</h2>
      <p>
        Aplicația este furnizată „ca atare", fără garanții de disponibilitate
        neîntreruptă. Putem face mentenanță, schimbări de funcționalități sau
        putem opri serviciul cu o notificare rezonabilă.
      </p>

      <h2>7. Limitarea răspunderii</h2>
      <p>
        În limita maximă permisă de lege, OXIDAȚII nu răspunde pentru:
      </p>
      <ul>
      ...
      <p>
        Poți șterge contul oricând din „Profil → Setări". Datele vor fi
        eliminate conform Politicii de confidențialitate.
      </p>

      <h2>9. Modificări</h2>
      <p>
        Putem modifica acești termeni. Vei fi notificat în aplicație cu cel
        puțin 14 zile înainte ca modificările să intre în vigoare. Continuarea
        utilizării după acea dată înseamnă acceptarea noilor termeni.
      </p>

      <h2>10. Lege aplicabilă</h2>
      <p>
        Acești termeni sunt guvernați de legea română. Orice litigiu va fi
        soluționat de instanțele competente din România, după o încercare
        prealabilă de mediere.
      </p>
    </LegalPage>
  );
}
