  ...
  return (
    <div className="relative pb-3 bg-[#050505] min-h-screen text-white overflow-hidden">
      ...
      {theme && profile?.handle && (
        <SignatureReveal theme={theme} handle={profile.handle} storageKey={`me:${profile.handle}`} />
      )}
      ...
      <header
        ...
        style={{ paddingTop: "calc(env(safe-area-inset-top) + 0.25rem)", height: "calc(env(safe-area-inset-top) + 3rem)" }}
      >
