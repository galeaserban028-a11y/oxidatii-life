      ...
      <div className="flex-1 flex items-center">
        <div className="w-full max-w-sm mx-auto space-y-6">
          ...
          <div className="flex items-center gap-3 text-xs text-muted-foreground">
            <div className="flex-1 h-px bg-foreground/10" /> sau cu email <div className="flex-1 h-px bg-foreground/10" />
          </div>
          ...
          <form onSubmit={handleEmail} className="space-y-3">
            ...
            <input type="password" required placeholder="parolă" value={pwd} onChange={e=>setPwd(e.target.value)}
              className="w-full rounded-xl bg-foreground/5 border border-foreground/10 px-4 py-3 text-sm focus:outline-none focus:border-neon-purple" />
