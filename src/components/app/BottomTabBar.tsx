...
import { Newspaper, Trophy, Camera, User, MapPin, Flame } from "lucide-react";
...
const tabs: Tab[] = [
  ...
  { to: "/app/parties", icon: Flame, label: "Haită" },
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-50 pb-[env(safe-area-inset-bottom)]">
      <div className="mx-auto max-w-md">
        <div className="m-2 rounded-2xl glass border border-foreground/10 grid grid-cols-6 backdrop-blur-xl">
          {tabs.map(t => {
